...
# initialize the list of class labels YOLO was trained to detect
...
# initialize the total number of frames processed thus far, along with the total number of people in the frame
totalFrames = 0
totalPeople = 0
...
while True:
    ...
    # resize the frame to have a maximum width of 416 pixels (the less data we have, the faster we can process it),
    ...
    # initialize the current status along with our list of bounding box rectangles returned by either
    ...
    if totalFrames % args["skip_frames"] == 0:
        ...
        # (as YOLO does not apply it by default)
    ...
    for (objectID, centroid) in objects.items():
        ...
        if to is None:
            ...
            totalPeople += 1  # New person detected, increment the total number of people
    ...
    # draw the total number of people on the frame
    cv2.putText(frame, "Total People: {}".format(totalPeople), (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 255), 2)
