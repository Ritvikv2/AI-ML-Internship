...
# Helper - ensures that the face is within the faces value
...
class FaceRecognition:
    # General lists used in the FaceRecognition class
    face_locations = []
    face_encodings = []
    face_names = []
    ...
    def encode_faces(self):
        image_directory = 'detection_methods/face_recognition/faces'
    ...
    def save_faces(self, frame, face_locations):
        ...
        for (top, right, bottom, left) in face_locations:
            ...
            if name not in self.saved_face_names:
                self.saved_face_names.add(name)
                filename = f'{self.output_directory}/{name}.jpg'
